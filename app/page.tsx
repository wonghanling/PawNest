            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 px-4 max-w-4xl mx-auto">
              <div className="group cursor-pointer">
                <div className="w-full bg-slate-200 dark:bg-slate-800 aspect-square rounded-xl overflow-hidden">
                  <img src="/3.jpg" alt="Dog" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                </div>
              ...
              <div className="group cursor-pointer">
                <div className="w-full bg-slate-200 dark:bg-slate-800 aspect-square rounded-xl overflow-hidden">
                  <img src="/2.jpg" alt="Cat" className="w-full h-full object-cover object-right group-hover:scale-105 transition-transform duration-300" />
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 px-4">
              ...
              <a href="/category" className="group cursor-pointer">
                <div className="w-full bg-white dark:bg-slate-800 aspect-square rounded-xl mb-3 md:mb-4 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                  <img src="/宠物房子1.jpg" alt="Comfort Living" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300" />
                </div>
              ...
              <a href="/category" className="group cursor-pointer">
                <div className="w-full bg-white dark:bg-slate-800 aspect-square rounded-xl mb-3 md:mb-4 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                  <img src="/推车2.jpg" alt="Travel & Safety" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="text-center">
              ...
              <a href="/category" className="group cursor-pointer">
                <div className="w-full bg-white dark:bg-slate-800 aspect-square rounded-xl mb-3 md:mb-4 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                  <img src="/清洁3.jpg" alt="Care & Hygiene" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="text-center">
              ...
              <a href="/category" className="group cursor-pointer">
                <div className="w-full bg-white dark:bg-slate-800 aspect-square rounded-xl mb-3 md:mb-4 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                  <img src="/玩具2.jpg" alt="Toys & Play" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="text-center">
              ...
              <a href="/category" className="group cursor-pointer">
                <div className="w-full bg-white dark:bg-slate-800 aspect-square rounded-xl mb-3 md:mb-4 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                  <img src="/智能家居1.jpg" alt="Smart & Home" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="text-center">
              ...
              <a href="/category" className="group cursor-pointer">
                <div className="w-full bg-white dark:bg-slate-800 aspect-square rounded-xl mb-3 md:mb-4 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                  <img src="/衣服3.jpg" alt="Style & Wear" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="text-center">
